export const carouselStyles = `
	.carousel {
		...
		--carousel-control-bg: #1b181c;
		--carousel-control-border: color-mix(in oklab, var(--surface-accent) 28%, white);
		--carousel-control-shadow: color-mix(in oklab, var(--surface-shadow) 24%, transparent);
...
export const productSearchStyles = `
	.search-island__root {
		...
		--search-action-bg: var(--surface-accent);
		--search-action-bg-hover: var(--interactive-link-hover);
		--search-action-border: var(--surface-accent);
...
export const gridItemsStyles = `
	.grid-items {
		...
		--grid-items-card-gap: var(--spacing-md, 1rem);
		--grid-items-card-padding: var(--spacing-lg, 1.5rem);
	...
	@media (max-width: 900px) {
		.grid-items[data-grid-items-layout="feature-first"] .grid-items__card--feature,
		.grid-items[data-grid-items-layout="feature-first"] .grid-items__card--supporting,
		.grid-items[data-grid-items-layout="even"] .grid-items__card {
			grid-column: span 6;
		}
